...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT) // WebMvcTest는 JPA 기능이 동작안함
public class PostsApiControllerTest {
    ...
    @Autowired
    private TestRestTemplate restTemplate; // @SpringBootTest와 함께 사용해아함
    ...
    public void register_new_post() throws Exception {
        // given
        String title = "title";
    ...
    @Test
    @WithMockUser(roles = "USER")
    public void modify_existing_post() throws Exception {
        // given
